      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-800 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            title="map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.352386224711!2d67.02806531500007!3d24.848396684057515!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33e15d5e1763b%3A0x4a1834448880f5ae!2sGovernor%20House%20Karachi!5e0!3m2!1sen!2s!4v1699290604739!5m2!1sen!2s"
            style={{ filter: 'grayscale(1) contrast(1.2) opacity(0.4)' }}
          ></iframe>
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
              <p className="mt-1 text-gray-700">Governor House, Karachi, Pakistan</p>
            </div>
